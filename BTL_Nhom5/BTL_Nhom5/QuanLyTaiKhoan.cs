    ...
    public partial class QuanLyTaiKhoan : Form
    {
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Mã Tài khỏoản không được để trống!", "thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
        ...
        private void dgv_QLTaiKhoan_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmbChucVu.SelectedValue = dgv_QLTaiKhoan.Rows[dong].Cells[2].Value.ToString();
        }
