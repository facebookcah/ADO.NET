...
namespace BTL_Nhom5
{
    public partial class BanHang : Form
    {
        ...
        private void list_DonHang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cb_KH.Text = bus.hashKH(dt.Rows[list_DonHang.SelectedIndex].ItemArray[1].ToString().Trim(), true);
            dt = bus.getHoaDonChiTiet(dt.Rows[list_DonHang.SelectedIndex].ItemArray[0].ToString().Trim());
            dt.Columns.Add("edit", typeof(Icon));
        ...
        private void btn_Xoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string maHD = dt.Rows[list_DonHang.SelectedIndex].ItemArray[0].ToString().Trim();
                bus.delHoaDon(maHD);
